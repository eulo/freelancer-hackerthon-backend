...
Client.prototype.__buildEndpoint = function(path, base) {
...
Client.prototype.__request = function(method, path, params, callback) {
  var base = 'rest';
  var stream = false;
 ...
 * STREAM
 */
Client.prototype.stream = function (method, params, callback) {
  if (typeof params === 'function') {
    callback = params;
    params = {};
  }
